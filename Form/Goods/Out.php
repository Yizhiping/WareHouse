...
<form method="post" action="?act=goods/out">
    <div style="border-bottom: 1px solid #222; padding: 5px 0 5px;">
        ...
        <input type="text" name="isn" id="isn" value="<?php print $isn ?>" class="input" />
...
//                print "<td><input type='checkbox' id='selAll'/></td>";
                print "<td><a href='#' id='selAll' style='display: block;'>全選</a></td>";
                ...
                {
                    $idx++;
                    print "<tr class='selRow resultContent'>";
                    printf( "<td>%d</td>", $idx);
